...
class Superwar {
    ...
    handleSelection = (target) => {
        ...
        if (this.isFight(selectedPlayer.strength) === 'clash')
            this.fight();
        else
            this.viewPlayers();
    }
    ...
    checkWin = () => {
        ...
        let result = "endure";
        let health = {"hero":this.totalStrength("hero"), "villain": this.totalStrength("villain")}

        result = health["hero"]>health["villain"]? "hero": health["hero"]==health["villain"]?
        "endure":"villain"; 
